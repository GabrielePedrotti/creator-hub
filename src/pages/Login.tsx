    ...
    <div className="min-h-screen bg-gradient-hero flex items-center justify-center p-4 dark">
      ...
      >
        ...
        <div className="glass-strong rounded-2xl p-8">
          ...
          {/* Google Sign In */}
          <button className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-border bg-secondary/50 hover:bg-secondary transition-colors mb-6">
